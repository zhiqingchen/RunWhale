  ...
  return (
    ...
    >
      <section>
        ...
        <p>开源社区版无需哪里跑账号，不包含订阅，也不向哪里跑发送使用统计或广告标识。明确标注为商业版的章节仅适用于商业版。</p>
      </section>

      <section>
        <h2>应用处理的信息</h2>
        <p>哪里跑会将项目、Git 历史、智能体会话、附件、偏好设置、项目缓存和生成的项目数据保存在设备上的应用本地容器中。模型服务商的 API 密钥和设备的 Git SSH 私钥使用操作系统的安全存储保存。</p>
        <p>社区版无需哪里跑账号或服务端即可运行。商业版提供可选的账号和订阅功能；账号服务不会保存你的项目或智能体会话副本。</p>
      </section>
      ...
      <section>
        <h2>发送给你所选服务的信息</h2>
        <p>AI 功能会将请求内容及回答所需的上下文发送给所选模型服务。社区版的数据接收方、数据类别、授权选择和服务商条款详见下一节。</p>
      ...
      <section>
        ...
        <p>社区版可在“设置 → 关于 → 隐私政策 → AI 数据共享”撤回 AI 同意。撤回会停止正在运行的智能体，并阻止进一步的模型请求，直到你再次同意。撤回不会移除第三方已接收的信息。应用内包含社区版隐私政策的离线副本。</p>
