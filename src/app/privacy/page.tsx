  ...
  return (
    ...
    >
      <section>
        ...
        <p>The open-source community edition does not require a RunWhale account, include subscriptions, or send usage analytics or advertising identifiers to RunWhale. The sections explicitly labeled commercial apply only to the commercial edition.</p>
      </section>
      ...
      <section>
        ...
        <p>AI features send request content and the context needed to answer it to the selected model service. The community edition’s recipients, data categories, consent choices, and provider terms are described in the next section.</p>
      ...
      <section>
        <h2>Community edition: third-party AI</h2>
