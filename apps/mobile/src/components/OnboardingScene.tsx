...
import { ArrowUpToLine, Check, Code2, Play, Plus } from '@/components/icons'
...
export function OnboardingScene({ page, active }: { page: number; active: boolean }) {
  const { t } = useI18n()
  ...
  return <View style={styles.stage} pointerEvents="none" accessibilityElementsHidden importantForAccessibility="no-hide-descendants">
