...
function createStyles(colors: ThemeColors) { return StyleSheet.create({
  ...
  secondaryButton: { height: 'auto', backgroundColor: colors.accentDeep, borderRadius: 12, minHeight: 44, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 },
  primaryButton: { height: 'auto', backgroundColor: colors.accent, minHeight: 50, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', borderRadius: 16, gap: 10 },
