...
describe('app languages', () => {
  ...
  it('interpolates messages after normalizing an unsupported locale', () => {
    expect(translateMessage(appLanguageForLocale('de'), 'updatedAt', { date: '2026-09-12' })).toBe('Updated 2026-09-12')
  })
